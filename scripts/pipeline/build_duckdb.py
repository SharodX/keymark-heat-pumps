#!/usr/bin/env python3
"""
DuckDB builder - builds keymark.duckdb from database JSON files.

Features:
- Load profile parsing (EN16147_001: S/M/L/XL/XXL/3XL/4XL → numeric codes)
- Time format parsing (EN16147_004: h:mm → decimal hours)
- Invalid entry detection (EN14825_027: non-numeric → -999)
- Preserves original values in value_text column

Run with: python scripts/pipeline/build_duckdb.py
"""
import json
import re
import sys
